...
class app(toga.App):  
    ...
    def set_initial_view(self):
        ...
        self.usuario = toga.TextInput(placeholder='acesso liberado, aperta entrar (temporário)')   #!!!!!!!!!!!!!!!!!!!!!!! trocar isso apos estiver pronto e colocar login
...
#                    briefcase run android -d "@android" -u
    ...
    def startup(self):
        ...
        self.main_window.title = "ScoreBoard"
    ...
    def wingspan_1player(self, widget):
        ...
        self.wingspan_box_row0 = toga.Box(style=Pack(direction=ROW))
        self.wingspan_box_row1 = toga.Box(style=Pack(direction=ROW))
        self.wingspan_box_row2 = toga.Box(style=Pack(direction=ROW))
        self.wingspan_box_row3 = toga.Box(style=Pack(direction=ROW))
        self.wingspan_box_row4 = toga.Box(style=Pack(direction=ROW))
        self.wingspan_box_row5 = toga.Box(style=Pack(direction=ROW))
        self.wingspan_box_row6 = toga.Box(style=Pack(direction=ROW))
        self.wingspan_box_row7 = toga.Box(style=Pack(direction=ROW))
        self.wingspan_box_row8 = toga.Box(style=Pack(direction=ROW, padding=(0, 0, 0, 240)))
        ...
        self.image0 = toga.Image("resources/players.png")
        self.image_players = toga.ImageView(image=self.image0, style=Pack(width=80, height=80))
        self.p1_name = toga.TextInput(placeholder='Jogador', style=Pack(flex=1, font_size=20, padding=(15, 0, 0, 0)))


        self.image1 = toga.Image("resources/p1.png")
        self.image_p1 = toga.ImageView(image=self.image1, style=Pack(width=80, height=80)) #(Largura, Altura)
        self.p1_ponto1 = toga.NumberInput(style=Pack(flex=1, padding=(25, 0, 0, 0)))


        self.image2 = toga.Image("resources/p2.png")
        self.image_p2 = toga.ImageView(image=self.image2, style=Pack(width=80, height=80, padding=(15, 0, 0, 0)))
        self.p1_ponto2 = toga.NumberInput(style=Pack(flex=1, padding=(50, 0, 0, 0)))


        self.image3 = toga.Image("resources/p3.png")
        self.image_p3 = toga.ImageView(self.image3, style=Pack( width=70, height=80, padding=(20, 0, 0, 6)))
        self.p1_ponto3 = toga.NumberInput(style=Pack(flex=1, padding=(55, 0, 0, 12)))


        self.image4 = toga.Image("resources/p4.png")
        self.image_p4 = toga.ImageView(self.image4, style=Pack(width=80, height=80, padding=(10, 0, 0, 6)))
        self.p1_ponto4 = toga.NumberInput(style=Pack(flex=1, padding=(30, 0, 0, 8)))


        self.image5 = toga.Image("resources/p5.png")
        self.image_p5 = toga.ImageView(self.image5, style=Pack(width=80, height=80, padding=(20, 0, 0, 0)))
        self.p1_ponto5 = toga.NumberInput(style=Pack(flex=1, padding=(55, 0, 0, 3)))


        self.image6 = toga.Image("resources/p6.png")
        self.image_p6 = toga.ImageView(self.image6, style=Pack(width=80, height=80, padding=(20, 0, 0, 0)))
        self.p1_ponto6 = toga.NumberInput(style=Pack(flex=1, padding=(40, 0, 0, 0)))


        self.p1_total_label = toga.Label('0', style=Pack(flex=1, padding=(0, 0, 0, 150), font_size=25))
        bnt_voltar = toga.Button('Voltar', on_press=self.quantidade_player)
        bnt_soma = toga.Button('Somar', on_press=self.p1_somar)

            # adicionar os itens nas boxs
        self.wingspan_box_row0.add(self.image_players)
        self.wingspan_box_row0.add(self.p1_name)

        self.wingspan_box_row1.add(self.image_p1)
        self.wingspan_box_row1.add(self.p1_ponto1)

        self.wingspan_box_row2.add(self.image_p2)
        self.wingspan_box_row2.add(self.p1_ponto2)

        self.wingspan_box_row3.add(self.image_p3)
        self.wingspan_box_row3.add(self.p1_ponto3)

        self.wingspan_box_row4.add(self.image_p4)
        self.wingspan_box_row4.add(self.p1_ponto4)

        self.wingspan_box_row5.add(self.image_p5)
        self.wingspan_box_row5.add(self.p1_ponto5)

        self.wingspan_box_row6.add(self.image_p6)
        self.wingspan_box_row6.add(self.p1_ponto6)

        self.wingspan_box_row7.add(self.p1_total_label)

        self.wingspan_box_row8.add(bnt_voltar)
        self.wingspan_box_row8.add(bnt_soma)



        self.wingspan_box.add(self.wingspan_box_row0)
        self.wingspan_box.add(self.wingspan_box_row1)
        self.wingspan_box.add(self.wingspan_box_row2)
        self.wingspan_box.add(self.wingspan_box_row3)
        self.wingspan_box.add(self.wingspan_box_row4)
        self.wingspan_box.add(self.wingspan_box_row5)
        self.wingspan_box.add(self.wingspan_box_row6)
        self.wingspan_box.add(self.wingspan_box_row7)
        self.wingspan_box.add(self.wingspan_box_row8)
    ...
    def wingspan_2player(self, widget):
        ...
        self.wingspan_box2_row9 = toga.Box(style=Pack(direction=ROW, padding=(0, 0, 0, 240)))
         ...
         # criar os itens para a tela
        self.image0 = toga.Image("resources/players.png")
        self.image_players = toga.ImageView(image=self.image0, style=Pack(width=70, height=70))
        self.p1_name = toga.TextInput(placeholder='Jogador 1', style=Pack(font_size=20, flex=1, padding=(15, 0, 0, 0)))
        self.p2_name = toga.TextInput(placeholder='Jogador 2', style=Pack(font_size=20, flex=1, padding=(15, 0, 0, 0)))


        self.image1 = toga.Image("resources/p1.png")
        self.image_p1 = toga.ImageView(image=self.image1, style=Pack(width=70, height=70)) #(Largura, Altura)
        self.p1_ponto1 = toga.NumberInput(style=Pack(flex=1, padding=(20, 0, 0, 0))) 
        self.p2_ponto1 = toga.NumberInput(style=Pack(flex=1, padding=(20, 0, 0, 0)))


        self.image2 = toga.Image("resources/p2.png")
        self.image_p2 =toga.ImageView(image=self.image2, style=Pack(width=70, height=70, padding=(10, 0, 0, 0)))
        self.p1_ponto2 = toga.NumberInput(style=Pack(flex=1, padding=(30, 0, 0, 0)))
        self.p2_ponto2 = toga.NumberInput(style=Pack(flex=1, padding=(30, 0, 0, 0)))


        self.image3 = toga.Image("resources/p3.png")
        self.image_p3 = toga.ImageView(self.image3, style=Pack( width=60, height=65, padding=(15, 0, 0, 6)))
        self.p1_ponto3 = toga.NumberInput(style=Pack(flex=1, padding=(30, 0, 0, 0)))
        self.p2_ponto3 = toga.NumberInput(style=Pack(flex=1, padding=(30, 0, 0, 0)))


        self.image4 = toga.Image("resources/p4.png")
        self.image_p4 = toga.ImageView(self.image4, style=Pack(width=70, height=70, padding=(10, 0, 0, 0)))
        self.p1_ponto4 = toga.NumberInput(style=Pack(flex=1, padding=(25, 0, 0, 0)))
        self.p2_ponto4 = toga.NumberInput(style=Pack(flex=1, padding=(25, 0, 0, 0)))


        self.image5 = toga.Image("resources/p5.png")
        self.image_p5 = toga.ImageView(self.image5, style=Pack(width=70, height=70, padding=(20, 0, 0, 0)))
        self.p1_ponto5 = toga.NumberInput(style=Pack(flex=1, padding=(40, 0, 0, 0)))
        self.p2_ponto5 = toga.NumberInput(style=Pack(flex=1, padding=(40, 0, 0, 0)))


        self.image6 = toga.Image("resources/p6.png")
        self.image_p6 = toga.ImageView(self.image6, style=Pack(width=70, height=70, padding=(25, 0, 0, 0)))
        self.p1_ponto6 = toga.NumberInput(style=Pack(flex=1, padding=(40, 0, 0, 0)))
        self.p2_ponto6 = toga.NumberInput(style=Pack(flex=1, padding=(40, 0, 0, 0)))


        
        self.p1_total_label = toga.Label('0', style=Pack(flex=1, padding=(0, 0, 0, 150), font_size=30))
        self.p2_total_label = toga.Label('0', style=Pack(flex=1, padding=(0, 0, 0, 120), font_size=30))
        bnt_voltar = toga.Button('Voltar', on_press=self.quantidade_player)
    ...
    def boardgames(self, widget):
        ...
        image_wing = toga.Image("resources/wingspan.png")
        self.app_content.add(toga.ImageView(image_wing, style=Pack(width=200, height=100, padding=(0, 100))))    
